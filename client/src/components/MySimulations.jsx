...
export default function MySimulations() {
  ...
  // GRAPH DATA
  const graphData = classes.map((cls) => ({
    name: cls.className,
    score: cls.score === "—" ? 0 : cls.score,
  }));
  ...
  return (
    <div>
      ...
      <div className="simulation-page-container">
        ...
        {/* ====  GRAPH SECTION  ==== */}
        <h2 className="title">📊 Progress Chart</h2>

        <div style={{ width: "100%", height: 300, marginBottom: "20px" }}>
          {/* <ResponsiveContainer>
            <BarChart data={graphData}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="name" label={{ value: "Class Name", position: "insideBottom", dy: 10 }} />
              <YAxis label={{ value: "Score", angle: -90, position: "insideLeft" }} />
              <Tooltip />
              <Bar dataKey="score" fill="#4e8cff" />
            </BarChart>
          </ResponsiveContainer> */}
          <ResponsiveContainer>
  <BarChart data={graphData}>
    ...
    <XAxis 
      ...
      interval={0}
      height={70}
      label={{ value: "Class Name", position: "insideBottom", dy: 10 }}
    />
    <YAxis label={{ value: "Score", angle: -90, position: "insideLeft" }} />
    <Tooltip />
    <Bar dataKey="score" fill="#4e8cff" />
